// Switch to the vacations database
db = db.getSiblingDB('vacations');

// Idempotent: only run if the vacations collection is empty
if (db.vacations.countDocuments() > 0) {
...
db.users.insertMany([
  {
    ...
    password: '$2a$10$X0ZXNb6nioSj0vG6eEgx4ukVce.Zb/1MJwl.FSIkCaVso27i9qCgG',
    role: 'admin'
  },
  {
    firstName: 'Test',
    ...
    password: '$2a$10$V.oeQyrw3hI.Az61H6szteHqS.Mb8cDyej94PrIN5Mc8m5goVHFJW',
    role: 'user'
  }
]);

print('Seed completed: 12 vacations, admin + test user inserted');
